package com.junfeng.platform.sc.config;

import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.handlers.MetaObjectHandler;
import com.junfeng.platform.sc.util.ContextHolderUtil;
...
public class InsertUpdateMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.setInsertFieldValByName("clientId",ContextHolderUtil.getClientId(),metaObject);
    }
