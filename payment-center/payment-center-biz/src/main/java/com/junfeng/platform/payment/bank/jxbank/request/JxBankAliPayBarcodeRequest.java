 ...
 * @author:xionghui
 * @date:2018年8月20日 下午3:45:17
 * @version 1.0
 */
@Data
@EqualsAndHashCode(callSuper=true)
public class JxBankAliPayBarcodeRequest extends JxBankBaseRequest {
     ...
     */
    public JxBankAliPayBarcodeRequest(JxBankBarcodeParam param) {
        this.uri="micropay";
        this.param = param;
    ...
    public Map<String, String> getParams() {
        ...
        params.put("trade_type", JxBankPayTypeEnum.JXBANK_ALIPAY_MICROPAY.getValue());
        return params;
    }
    /**
     * 返回对象
