 ...
 * @version 1.0
 */
public class UnionpayMiniWebUtils {
     ...
     * @throws IOException
     * @author:李麒
     * @createTime:2018年10月25日 下午3:53:28
     */
    public static String doPost(UnionpayMiniBaseRequest request)
            throws InvalidKeyException, NoSuchAlgorithmException, URISyntaxException, IOException {
        String jsonString = JSON.toJSONString(request.getRequestParam());
        LOGGER.info("jsonString:{}",jsonString);
        return post(UnionpayMiniConstant.HOST, jsonString);
    }
     ...
     * @throws IOException
     * @author:李麒
     * @createTime:2018年10月25日 下午3:54:09
     */
    private static String post(String url, String jsonString) throws URISyntaxException, IOException {
