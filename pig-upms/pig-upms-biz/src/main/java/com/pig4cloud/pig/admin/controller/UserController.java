...
public class UserController {
	...
	@Inner
	@PostMapping("/add")
	public R<Integer> createUser(@RequestBody SysUser sysUser) {
		SysUser dbSysUser = userService.getOne(Wrappers.<SysUser>lambdaQuery().eq(SysUser::getUsername, sysUser.getUsername()));
		if (dbSysUser != null) {
			return R.failed("已存在注册用户");
		}
	...
	@Inner
	@PostMapping("/update")
	public R<Boolean> bindUser(@Valid @RequestBody SysUser sysUser) {
