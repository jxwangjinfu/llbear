...
import com.junfeng.platform.payment.bank.cmbank.common.CmConstant;
...
public class CmBankWebUtils {
     ...
     */
    public static String doPost(CmBankBaseRequest request) throws IOException, URISyntaxException {
        // TODO Auto-generated method stub
        String params = TanslateUtil.map2xml(request.getRequestParams());
        return post(CmConstant.CM_BANK_URL, params);
    }
