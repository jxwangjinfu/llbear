...
public class CiticBankSignUtils {
  ...
  //请求时根据不同签名方式去生成不同的sign
    ...
    //对返回参数的验证签名
    public static boolean verifySign(String sign,String signType,Map<String,String> resultMap,String privateKey) throws Exception{
        if("RSA_1_256".equals(signType)){
