...
public class AbcBankWebUtils {
     ...
     */
    public static String doPost(BaseAbcBankRequest request) throws Exception {
        // TODO Auto-generated method stub
        String params = TanslateUtil.mapToString(request.getSharedParams());
        LOGGER.info("params:{}", params);
        return post(AbcBankConstant.ABC_BANK_URL, params);
    }
    ...
    private static String post(String url, String params) throws URISyntaxException, IOException {
        ...
        return getResult(httpClient, url, httpGet);
     ...
     */
    private static String getResult(HttpClient httpClient, String url, HttpGet method) throws IOException {
