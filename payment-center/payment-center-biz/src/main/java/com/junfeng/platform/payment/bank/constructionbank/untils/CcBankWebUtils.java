...
public class CcBankWebUtils {
     ...
     */
    public static String doPost(ConstructionBankBaseRequest request) throws IOException, URISyntaxException {
        // TODO Auto-generated method stub
        String param = TanslateUtil.map2Serialization(request.getRequestParams());
        StringBuilder sb = new StringBuilder();
        sb.append(ConstructionBankConstant.HOST);
        sb.append("?");
        sb.append(param);
        return post(sb.toString(), null);
    }
